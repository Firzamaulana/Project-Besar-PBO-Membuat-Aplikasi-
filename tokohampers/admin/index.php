    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Hampers</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;">&nbsp; <a href="index.php?halaman=komentar"><i class="fa fa-envelope fa-lg" ></i></a>  | <img src="../fotoprofil/DSC_0170 bw.png" width="20px" style="border-radius: 15px; -moz-border-radius:15px;"></a></div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="../fotoprofil/DSC_0170 bw.png" class="user-image img-responsive"/>
					</li>
